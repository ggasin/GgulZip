					...
					<div class="card">
						<div class="card-body pt-3">
							...
							<div class="tab-content pt-2">
								...
								<form action="${contextPath}/membUpdate.my" method="post">
	                      ...
	                      부트스트랩에서 제공하는 업로드버튼형식의 div가 있고, div를 클릭하면 file창이 열림.-->
										...
										<div class="row mb-3">
											...
											<div class="col-md-8 col-lg-9">
												...
												<input name="enrollDate" type="date" class="form-control"
													id="enrollDate" value="${loginMember.enrolldate}">
											</div>
										</div>
				        ...
				        success : function(result){
				            ...
				            if(result.length>0){
				            	for(var i=0; i<result.length;i++){
					                ...
					                var content = $("<td></td>").text(result[i].content);
					                var writer = $("<td></td>").text(result[i].writerNo);
