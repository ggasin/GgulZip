	...
	<div class="outer">
			...
			<tbody>
				...
				<c:choose>
					<c:when test="${empty list }">
						<tr>
							<td colspan='6' onclick="location.href='${pageContext.request.contextPath}/FreeClickList.bo'">게시글이 없습니다.</td>
						</tr>
					</c:when>
					<c:otherwise>
		...
		<c:if test="${not empty loginUser }">
			...
			<div align="center">
				...
				<button onclick="location.href='${pageContext.request.contextPath}/FreeInsert.bo'">글작성</button>
