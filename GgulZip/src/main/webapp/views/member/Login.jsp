...
<div align="center" >
    <div style="display: flex; align-items: center; justify-content: center;" onclick="window.location.href = '../webapp/index.jsp';">
        ...
        <img src="../img/bee.png" alt="Bee Image" width="50" height="50" style="display: inline;">
    </div>
</div>
