			...
			<table class="table">
				...
				<tbody>
					...
					<c:forEach items="${clist}" var="c">
						<tr style="text-align: center">
							<td><input type="text" name="no2" value="${c.categoryNo}"
								style="width: 50px; text-align: center;" readonly></td>
							<td><input type="text" name="name2"
								value="${c.categoryName}"
								style="width: 130px; text-align: center;"></td>
							<td><input type="button" onclick="updateCategory(this);"
								value="수정"></td>
							<td><input type="button" onclick="deleteCategory(this);"
								value="삭제"></td>
						</tr>
					</c:forEach>
				</tbody>
