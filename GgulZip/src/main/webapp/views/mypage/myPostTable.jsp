...
<body>
	<div class="tab-pane fade profile-edit pt-3" id="profile-post">
		<div id="myPost-header">
			...
			<div class="flexDiv">
				<button id="showMyPostChkBoxBtn" class="btn btn-primary" style="display:none">선택</button>
				<button id="clearMyPostChkBoxBtn" class="btn btn-secondary" style="display:none">선택 해제</button>
				<button id="deleteMyPostBtn" class="btn btn-danger" style="display:none">삭제</button>	
			</div>
		</div>
